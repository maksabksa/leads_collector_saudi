...
قدم تحليلاً شاملاً بصيغة JSON فقط (بدون أي نص خارج JSON) وفق الهيكل التالي:
{
  ...
  "technicalGaps": ["ثغرة تقنية حقيقية غير موجودة في الموقع"],
  "contentGaps": ["ثغرة محتوى حقيقية من الموقع"],
  "overallScore": 6,
  "summary": "ملخص تحليلي واضح في سطرين بناءً على المحتوى الحقيقي",
  "recommendations": ["توصية 1 لميزة غير موجودة", "توصية 2", "توصية 3"],
  "biggestMarketingGap": "الثغرة الأكبر الحقيقية الغائبة فعلاً عن الموقع في سطرين على الأقل",
